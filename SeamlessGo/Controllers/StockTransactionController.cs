...
//            try
//            {
//                var StockTransactions = await _StockTransactionRepository.GetAllAsync();
...
//                    DeliveryLocationID = createStockTransactionDto.DeliveryDate,
...
//                CustomerID = StockTransaction.CustomerID,
//                StockTransactionDate = StockTransaction.StockTransactionDate,
...
//                NetAmount = StockTransaction.NetAmount,
//                Tax = StockTransaction.Tax,
//                TaxPerc = StockTransaction.TaxPerc,
//                Status = StockTransaction.Status,
//                CreatedByUserID = StockTransaction.CreatedByUserID,
//                RouteID = StockTransaction.RouteID,
//                IsVoided = StockTransaction.IsVoided,
//                Note = StockTransaction.Note,
//                SourceStockTransactionID = StockTransaction.SourceStockTransactionID,
//                SourceOrderID = StockTransaction.SourceOrderID,
//                SyncStatus = StockTransaction.SyncStatus,
//                StockTransactionLine = StockTransaction.StockTransactionLine?.Select(line => new StockTransactionLineDTO
//                {
//                    StockTransactionLineID = line.StockTransactionLineID,
//                    StockTransactionID = line.StockTransactionID,
